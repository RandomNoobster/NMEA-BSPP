...
public class BasicNMEAAdapter implements BasicNMEAHandler {
    ...
    @Override
    public void onGGA(long time, double latitude, double longitude, float altitude, BasicNMEAHandler.FixQuality quality, int satellites, float hdop) {}
    @Override
    public void onGSV(int satellites, int index, int prn, float elevation, float azimuth, int snr) {}
    @Override
    public void onGSA(BasicNMEAHandler.FixType type, Set<Integer> prns, float pdop, float hdop, float vdop) {}
    @Override
